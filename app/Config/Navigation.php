...
return [
    ...
    'groups' => [
        ...
        ['id' => 'warehouse-department', 'label' => 'Bodega', 'description' => 'Inventario, bodegas, lotes, solicitudes y abastecimiento.', 'icon' => 'boxes', 'order' => 20, 'visible' => true, 'department' => 'bodega', 'badge' => null, 'count' => null, 'items' => [
            ...
            ['id' => 'procurement-module', 'module' => 'procurement', 'label' => 'Compras y Abastecimiento', 'route' => '/procurement', 'permission' => 'procurement.view', 'icon' => 'cart', 'order' => 40, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'receptions-module', 'module' => 'receptions', 'label' => 'Recepciones', 'route' => '/receptions', 'permission' => 'procurement.receive', 'icon' => 'boxes', 'order' => 50, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'notifications-module', 'module' => 'notifications', 'label' => 'Notificaciones', 'route' => '/notifications', 'permission' => 'notifications.view', 'icon' => 'chart', 'order' => 60, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ]],
        ['id' => 'hr-accounting', 'label' => 'RRHH / Contabilidad', 'description' => 'Personas, mano de obra, costos y control presupuestario.', 'icon' => 'users', 'order' => 30, 'visible' => true, 'department' => 'rrhh', 'badge' => null, 'count' => null, 'items' => [
            ['id' => 'labor-module', 'module' => 'labor', 'label' => 'Mano de Obra y Trabajadores', 'route' => '/labor', 'permission' => 'labor.view', 'icon' => 'users', 'order' => 10, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ...
        ['id' => 'administration', 'label' => 'Administración', 'description' => 'Operación agrícola, planificación, activos y documentos.', 'icon' => 'plant', 'order' => 40, 'visible' => true, 'department' => 'administracion', 'badge' => null, 'count' => null, 'items' => [
            ['id' => 'production-module', 'module' => 'production', 'label' => 'Producción', 'route' => '/production', 'permission' => 'production.view', 'icon' => 'plant', 'order' => 10, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'planning-module', 'module' => 'planning', 'label' => 'Tareas y Calendario', 'route' => '/planning', 'permissions' => ['tasks.view', 'calendar.view'], 'icon' => 'chart', 'order' => 20, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'machinery-module', 'module' => 'machinery', 'label' => 'Maquinaria', 'route' => '/machinery', 'permission' => 'machinery.view', 'icon' => 'wrench', 'order' => 30, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ...
            ['id' => 'masters-module', 'module' => 'masters', 'label' => 'Maestros Agrícolas', 'route' => '/masters', 'permission' => 'masters.view', 'icon' => 'wrench', 'order' => 50, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ]],
        ['id' => 'management', 'label' => 'Gerencia', 'description' => 'Indicadores ejecutivos, informes y trazabilidad de actividad.', 'icon' => 'chart', 'order' => 50, 'visible' => true, 'department' => 'gerencia', 'badge' => null, 'count' => null, 'items' => [
            ['id' => 'reports-module', 'module' => 'reports', 'label' => 'Dashboard Ejecutivo e Informes', 'route' => '/reports', 'permission' => 'reports.view', 'icon' => 'chart', 'order' => 10, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'audit-module', 'module' => 'audit', 'label' => 'Actividad del Sistema', 'route' => '/audit', 'permission' => 'reports.view', 'icon' => 'chart', 'order' => 20, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ]],
        ['id' => 'system-administration', 'label' => 'Administración del Sistema', 'description' => 'Usuarios, roles, catálogos, configuración e integraciones.', 'icon' => 'shield', 'order' => 60, 'visible' => true, 'department' => 'sistema', 'badge' => null, 'count' => null, 'items' => [
            ['id' => 'users-system', 'module' => 'users', 'label' => 'Usuarios y Roles', 'route' => '/users', 'permissions' => ['users.view', 'users.manage', 'roles.manage'], 'icon' => 'users', 'order' => 10, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'catalogs-system', 'module' => 'catalogs', 'label' => 'Catálogos', 'route' => '/catalogs', 'permission' => 'setup.manage', 'icon' => 'boxes', 'order' => 20, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ...
            ['id' => 'tools-system', 'module' => 'tools', 'label' => 'Herramientas', 'route' => '/tools', 'permission' => 'setup.manage', 'icon' => 'wrench', 'order' => 40, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'api-system', 'module' => 'api', 'label' => 'API e Integraciones', 'route' => '/api', 'permission' => 'api_tokens.manage', 'icon' => 'chart', 'order' => 50, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ]],
