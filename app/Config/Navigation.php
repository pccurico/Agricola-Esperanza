...
return [
    ...
    'groups' => [
        ...
        ['id' => 'production', 'label' => 'Producción Agrícola', 'description' => 'Planificación y operación agrícola.', 'icon' => 'plant', 'order' => 20, 'visible' => true, 'badge' => null, 'count' => null, 'items' => [
            ...
            ['id' => 'planning-module', 'module' => 'planning', 'label' => 'Tareas y Calendario', 'route' => '?module=planning', 'permission' => 'tasks.view', 'icon' => 'chart', 'order' => 20, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'labor-production', 'module' => 'labor', 'label' => 'Mano de Obra', 'route' => '?module=labor', 'permission' => 'labor.view', 'icon' => 'users', 'order' => 30, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'machinery-module', 'module' => 'machinery', 'label' => 'Maquinaria', 'route' => '?module=machinery', 'permission' => 'machinery.view', 'icon' => 'wrench', 'order' => 40, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'documents-production', 'module' => 'documents', 'label' => 'Documentos', 'route' => '?module=documents', 'permission' => 'documents.view', 'icon' => 'boxes', 'order' => 50, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ]],
        ['id' => 'warehouse', 'label' => 'Bodega e Inventario', 'description' => 'Existencias, bodegas y administración de inventario.', 'icon' => 'boxes', 'order' => 30, 'visible' => true, 'badge' => null, 'count' => null, 'items' => [
            ...
            ['id' => 'masters-inventory', 'module' => 'masters', 'label' => 'Administración de Inventario', 'route' => '?module=masters', 'permission' => 'masters.view', 'icon' => 'wrench', 'order' => 30, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ]],
        ['id' => 'procurement', 'label' => 'Compras y Abastecimiento', 'description' => 'Solicitudes, compras, recepciones y alertas.', 'icon' => 'cart', 'order' => 40, 'visible' => true, 'badge' => null, 'count' => null, 'items' => [
            ['id' => 'requests-module', 'module' => 'requests', 'label' => 'Solicitudes Internas', 'route' => '?module=requests', 'permission' => 'requests.view', 'icon' => 'cart', 'order' => 10, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'procurement-module', 'module' => 'procurement', 'label' => 'Compras', 'route' => '?module=procurement', 'permission' => 'procurement.view', 'icon' => 'cart', 'order' => 20, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'receptions-module', 'module' => 'receptions', 'label' => 'Recepciones', 'route' => '?module=receptions', 'permission' => 'procurement.receive', 'icon' => 'boxes', 'order' => 30, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'notifications-module', 'module' => 'notifications', 'label' => 'Notificaciones', 'route' => '?module=notifications', 'permission' => 'notifications.view', 'icon' => 'chart', 'order' => 40, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ]],
        ['id' => 'finance', 'label' => 'Administración y Finanzas', 'description' => 'Control financiero, costos, presupuestos e informes.', 'icon' => 'dollar', 'order' => 50, 'visible' => true, 'badge' => null, 'count' => null, 'items' => [
            ['id' => 'costs-finance', 'module' => 'costs', 'label' => 'Costos', 'route' => '?module=costs', 'permission' => 'costs.view', 'icon' => 'dollar', 'order' => 10, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'budgets-finance', 'module' => 'budgets', 'label' => 'Presupuestos', 'route' => '?module=budgets', 'permission' => 'budgets.view', 'icon' => 'chart', 'order' => 20, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
            ['id' => 'reports-finance', 'module' => 'reports', 'label' => 'Informes', 'route' => '?module=reports', 'permission' => 'reports.view', 'icon' => 'chart', 'order' => 30, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ]],
        ['id' => 'human-resources', 'label' => 'Recursos Humanos', 'description' => 'Gestión de personas y mano de obra.', 'icon' => 'users', 'order' => 60, 'visible' => true, 'badge' => null, 'count' => null, 'items' => [
        ...
        ['id' => 'system-administration', 'label' => 'Administración del Sistema', 'description' => 'Usuarios, catálogos, configuración e integraciones.', 'icon' => 'shield', 'order' => 80, 'visible' => true, 'badge' => null, 'count' => null, 'items' => [
            ['id' => 'users-system', 'module' => 'users', 'label' => 'Usuarios y Roles', 'route' => '?module=users', 'permission' => 'users.manage', 'icon' => 'users', 'order' => 10, 'visible' => true, 'badge' => null, 'count' => null, 'favorite' => false],
        ...
        ['id' => 'tools', 'label' => 'Herramientas', 'description' => 'Utilidades de soporte y demostración.', 'icon' => 'wrench', 'order' => 90, 'visible' => true, 'badge' => null, 'count' => null, 'items' => [
