...
<body class="admin-page">
    <main class="admin-shell">
        ...
        <section class="module-content documents-v2 module-v2">
            <header class="page-hero">
                <div class="hero-meta">
                    <div class="hero-title">
                        <p class="eyebrow">Trazabilidad</p>
                        <h1>Documentos y adjuntos</h1>
                        <p class="lead-text">Registra facturas, contratos, guías y archivos asociados a la operación.</p>
                    </div>
            ...
            <div class="page-grid v2">
                <main class="main-column">
                    <section class="section-card">
                        <div class="panel-header"><div><h2>Nuevo documento</h2></div></div>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Número</label>
                                <input name="document_number" maxlength="100">
                            </div>
                            <div class="form-group">
                                <label>Fecha</label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="supplier_id"><option value="">Sin proveedor</option><?php foreach ($suppliers as $supplier): ?><option value="<?= (int) $supplier['id'] ?>"><?= htmlspecialchars((string) ($supplier['business_name'] ?? ''), ENT_QUOTES, 'UTF-8') ?></option><?php endforeach; ?></select>
                            </div>
                            <div class="form-group">
                                <label>Cliente</label>
                                <select name="client_id"><option value="">Sin cliente</option><?php foreach ($clients as $client): ?><option value="<?= (int) $client['id'] ?>"><?= htmlspecialchars((string) ($client['business_name'] ?? ''), ENT_QUOTES, 'UTF-8') ?></option><?php endforeach; ?></select>
                            </div>
                            <div class="form-group">
                                <label>Adjunto</label>
                                <input type="file" name="attachment" accept="application/pdf,image/jpeg,image/png,image/webp,.xlsx">
                            </div>
                            <div class="form-actions"><button class="primary-button" type="submit">Guardar documento</button></div>
                        </form>
                        </div>
                    </section>

                    <section class="section-card">
                        <div class="panel-header"><div><h2>Documentos registrados</h2></div></div>
                        <div class="panel-body">
