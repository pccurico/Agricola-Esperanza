...
<head>
    ...
    <title>Actividad | Sistema de Gestión Agrícola PCCURICO</title>
                ...
                <div class="table-scroll">
                    <table class="admin-table">
                        ...
                        <tbody><?php foreach ($logs as $log): ?><tr>
                                    ...
                                    <td><span class="status-pill status-active"><?= htmlspecialchars($log['action']) ?></span></td>
                                    <td><?= htmlspecialchars($log['entity_type']) ?></td>
                                    <td><?= htmlspecialchars($log['ip_address'] ?: 'Local') ?></td>
