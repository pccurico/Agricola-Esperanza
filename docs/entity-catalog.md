...
| `purchase_receptions` | Recepciones parciales o completas de órdenes. Compras. | `purchase_orders`, documentos, usuario, líneas. | Inventario, costos, dashboard, reportes y trazabilidad documental. | `procurement.receive`; auditoría de recepción y estado; exportación/API. | Solo órdenes vigentes; transacción atómica; estado parcial o recibido. |
| `purchase_reception_items` | Cantidades efectivamente recibidas. Compras. | Recepción, línea de orden, artículo. | Movimientos de inventario y saldos de compra. | Hereda permisos de recepción; auditoría con cabecera. | Cantidad positiva; no supera saldo pendiente. |
